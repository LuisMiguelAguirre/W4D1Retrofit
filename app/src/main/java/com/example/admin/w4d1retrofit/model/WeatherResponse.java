...
public class WeatherResponse {
    ...
    public static WeatherResponse objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), WeatherResponse.class);
    ...
    public static java.util.List<WeatherResponse> arrayWeatherResponseFromData(String str) {
    ...
    public static java.util.List<WeatherResponse> arrayWeatherResponseFromData(String str, String key) {
